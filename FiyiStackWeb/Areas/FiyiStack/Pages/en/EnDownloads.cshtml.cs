...
namespace FiyiStackWeb.Areas.FiyiStack.Pages
{
    public class DownloadsModel : PageModel
    {
        public void OnGet()
        {
            ...
            ViewData["og:title"] = $@"<meta property=""og:title"" content=""Download FiyiStack, FiyiRequirements or CanariasBlog."">";
            ViewData["robot"] = $@"<meta name=""robots"" content=""index"">";
            ViewData["title"] = $@"Download FiyiStack, FiyiRequirements or CanariasBlog.";
